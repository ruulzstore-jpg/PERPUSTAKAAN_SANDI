...
--
-- Host: 127.0.0.1
-- Generation Time: 15 Jan 2026 pada 03.13
...
CREATE TABLE `buku` (
  ...
  `pernerbit` varchar(100) DEFAULT NULL,
...
ALTER TABLE `detail_peminjaman`
  ...
  ADD UNIQUE KEY `id_detail` (`id_detail`,`id_pinjam`,`id_buku`),
